const  XBOT = 'botalpinofc'; // Nama Bot Whatsapp
const instagram = 'https://instagram.com/alpin_Xploit'; // Nama Instagramlu cok
const nomer = 'https://Wa.me/+6289690719275'; // Nomor whatsapplu cok
...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            ...
            + 'TEL;type=CELL;type=VOICE;waid=6289690719275:\+62 896-9071-9275n' // WhatsApp ID + phone number
            + 'END:VCARD'
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @alpin`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @alpin`)
})
...
conn.sendMessage(id, 'Owner bot tsubasa wa.me/+6289690719275' ,MessageType.text);
}
else if (text == 'alpin'){
conn.sendMessage(id, 'Aku BOT nya tsubasa' ,MessageType.text);
}
else if (text == 'audio'){
